(library (nmosh debugger condition-printer)
	 (export condition-printer/deco
                 debug-format
...
(define (condition-printer/deco e)
  (cond
    ((syntax-trace-condition? e)
     (syntax-trace-printer e (current-error-port)))
    (else (condition-printer/base e (current-error-port)))))
